...
import { EIP_PORT } from "../config.ts";
import * as encapsulation from "./cip/encapsulation.ts";
import { promiseTimeout } from "../utils/utilities.ts";
import { lookup } from "node:dns";
import { Buffer } from "node:buffer";
import * as MessageRouter from "./cip/message-router.ts";
import * as DataTypes from "./cip/data-types.ts";
import * as EPATH from "./cip/epath/epath.ts";
import * as UnconnectedSend from "./cip/unconnected-send.ts";
import * as ConnectionManager from "./cip/connection-manager.ts";
...
export type enipSession = {
  id: number;
  establishing: boolean;
  established: boolean;
};

export type enipConnection = {
  id: number;
  establishing: boolean;
  established: boolean;
  seq_num: number;
...
export type enipError = { code: number; msg: string };

export interface ENIPState {
  TCP: enipTCP;
  session: enipSession;
...
const EthernetIP = { encapsulation, ENIP, CIP };
export default EthernetIP;
